function [Inliers_id, Outliers_id, value] = Outlier_Detect_v2(X_tilde, detect_flag, alpha, validation, affine)
...
fprintf(['\t-->alpha = ' num2str(alpha) ', validation = '  num2str(validation) '<--\n']);
