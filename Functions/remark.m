...
%     fprintf(...
%         [ '\t\taccuracy    = '  sprintf('%.3f', test.accuracy)        ...
%         '\n\t\tprecision   = '  sprintf('%.3f', test.precision)       ...
%         '\n\t\trecall      = '  sprintf('%.3f', test.recall)          ...
%         '\n\t\tspecificity = '  sprintf('%.3f', test.specificity)     ...
%         '\n\t\tF1 score    = '  sprintf('%.3f', test.F1)        '\n'] ...
%     )
